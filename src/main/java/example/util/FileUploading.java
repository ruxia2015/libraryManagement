...
import example.controller.BookInfoController;
...
public class FileUploading {
    ...
    public static String  fileUpload(@RequestParam("file") MultipartFile file,  String bookPicture ) throws IOException {
        if(file != null){
            try {
