...
<%--                                &lt;%&ndash;                                <span class="badge badge-info right">6</span>&ndash;%&gt;--%>
<%--                            </p>--%>
<%--                        </a>--%>
...
<%--                    </li>--%>
                    <li class="nav-item has-treeview menu-open" >
                        ...
                        <ul class="nav nav-treeview" >
                            ...
                            <li class="nav-item">
                                <a href="${pageContext.request.contextPath}/user/workbench/c" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>C</p>
                                </a>
                            </li>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">C</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/user/userBooks">图书大厅</a></li>
