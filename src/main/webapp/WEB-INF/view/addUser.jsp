...
<script type="text/javascript" >
    ...
    function goBack() {
        window.location.href ="${pageContext.request.contextPath}/user/queryAllUser"
    }
...
<div id="register">
    ...
    <form id="registerForm" method="post" action="${pageContext.request.contextPath}/librarian/addUserMethod">
        <div>
            <p>
        ...
        <div id="register_control";>
            <input type="submit" id="btn_register" value="保存" />
